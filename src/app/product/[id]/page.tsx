...
import {
  Heart, ChevronDown, Star, Clock,
  Truck, RotateCcw, Sparkles, ArrowRight,
} from "lucide-react";
import { Navbar }      from "@/components/layout/Navbar";
import { Footer }      from "@/components/layout/Footer";
import { ProductCard } from "@/components/shared/ProductCard";
import { useCart }     from "@/context/CartContext";
import { ALL_PRODUCTS, getProductBySlugOrId } from "@/constants";
...
const Ornament = () => (
  <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "24px 0" }}>
    ...
    <div style={{ width: 5, height: 5, border: "1px solid rgba(184,160,122,.50)", transform: "rotate(45deg)", flexShrink: 0 }} />
    <div style={{ flex: 1, height: 1, background: "rgba(184,160,122,.32)" }} />
  </div>
);
...
export default function ProductDetailPage({ params }: ProductPageProps) {
  ...
  if (!product) {
    return (
      <div style={{ minHeight: "100vh", background: "#F2EDE5", display: "flex", flexDirection: "column" }}>
        <Navbar />
        <main style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24, padding: "0 24px", textAlign: "center" }}>
          <h2 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "2.5rem", color: "#1A1714" }}>Product Not Found</h2>
          <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: 14, color: "#7A7269" }}>The piece you are looking for is no longer in the collection.</p>
          <Link href="/" style={{ fontFamily: "'Inter', sans-serif", fontSize: 9, fontWeight: 500, letterSpacing: ".28em", textTransform: "uppercase", color: "#1A1714", textDecoration: "none", padding: "14px 32px", border: "0.5px solid rgba(26,23,20,.25)" }}>
            Return Home
          </Link>
        </main>
        <Footer />
      ...
      <div className="pd" style={{ background: "#F2EDE5", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <main style={{ flex: 1, position: "relative", zIndex: 1, maxWidth: 1280, width: "100%", margin: "0 auto", padding: "clamp(6rem, 12vh, 9rem) 40px clamp(5rem, 10vh, 8rem)" }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              ...
              <div className="pd-gallery-main">
                ...
                {(["tl","tr","bl","br"] as const).map((pos) => (
                  <div key={pos} className="pd-gallery-corner" style={{
                    top:    pos[0]==="t" ? 14 : "auto", bottom: pos[0]==="b" ? 14 : "auto",
                    left:   pos[1]==="l" ? 14 : "auto", right:  pos[1]==="r" ? 14 : "auto",
                    borderTop:    pos[0]==="t" ? "1px solid rgba(184,160,122,.6)" : "none",
                    borderBottom: pos[0]==="b" ? "1px solid rgba(184,160,122,.6)" : "none",
                    borderLeft:   pos[1]==="l" ? "1px solid rgba(184,160,122,.6)" : "none",
                    borderRight:  pos[1]==="r" ? "1px solid rgba(184,160,122,.6)" : "none",
                  }} aria-hidden="true" />
                ))}
              </div>
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "5fr 7fr", gap: 48, marginBottom: 80 }}>

              {/* Rating panel */}
              <div className="pd-review" style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                <div>
